  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="pb-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-stone-100 mb-2">X.com Profiles</h2>
            <p className="text-stone-400">Manage X.com profile timelines</p>
          </div>
          
          <div className="bg-stone-900 border border-stone-800 rounded-lg p-8 text-center">
            <p className="text-stone-400 mb-4">Profile management UI coming in Phase 5</p>
