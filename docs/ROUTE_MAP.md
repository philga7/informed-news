...
| `/radar` | **Radar** (claim inbox + story triage) | Session-required. **Primary:** claim inbox from `GET /api/claims/radar` — Needs review + Claims lists with status/evidence/confidence chips; expandable linked headlines per claim ([NEWS-74](https://informedcrew.atlassian.net/browse/NEWS-74)). **Secondary:** collapsible **Headline clusters** section from story `GET /api/radar` (CFP + curated RSS) — **Accept / Unaccept** per cluster ([NEWS-65](https://informedcrew.atlassian.net/browse/NEWS-65)) → Brief; **Track / Untrack** beside Accept ([NEWS-59](https://informedcrew.atlassian.net/browse/NEWS-59)) until claim Accept/Track ships ([NEWS-75](https://informedcrew.atlassian.net/browse/NEWS-75)). **Tracked** section lists watched story clusters (including muted tracked clusters with a muted label); pending tracked updates show an **Update** dot and **Dismiss** ([NEWS-61](https://informedcrew.atlassian.net/browse/NEWS-61)). Accepted + tracked → **Open on Brief** (`/`). Footer **Radar** link shows a dot/count when any tracked entry has a pending update. **Mute** ([NEWS-60](https://informedcrew.atlassian.net/browse/NEWS-60)): keyword (+ optional source) rules; muted clusters hidden from headline clusters with **Hidden N** when `hiddenMutedCount > 0`; add/list/delete via session mute APIs. No claim Accept/Track/Mute controls yet — display only on claim cards. Epic: [NEWS-57](https://informedcrew.atlassian.net/browse/NEWS-57), [NEWS-69](https://informedcrew.atlassian.net/browse/NEWS-69). |
...
Desk v1 actions on `/radar` are live: **Accept** ([NEWS-65](https://informedcrew.atlassian.net/browse/NEWS-65)), **Track / Untrack** + **Tracked** section ([NEWS-59](https://informedcrew.atlassian.net/browse/NEWS-59)), **Mute** ([NEWS-60](https://informedcrew.atlassian.net/browse/NEWS-60)), plus the in-app `pendingUpdate` alert badge/dismiss flow ([NEWS-61](https://informedcrew.atlassian.net/browse/NEWS-61)). **Manual seeds** and Brief **Unaccept** are live on `/` ([NEWS-66](https://informedcrew.atlassian.net/browse/NEWS-66)). Brief shows accepted clusters only, minus global mute. No additional product routes yet.
