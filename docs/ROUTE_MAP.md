...
| `/radar` | **Radar** (triage / headline lane) | Session-required. CFP + curated RSS v1. Footer link (not a header product tab). Accept → Brief; Track = alerts; Mute = global. Epic: [NEWS-57](https://informedcrew.atlassian.net/browse/NEWS-57). |
...
Remaining NEWS-57 desk actions (Accept, Track, Mute, manual seeds) ship on `/radar` and Brief — no additional product routes yet.
