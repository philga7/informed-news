...
Start at **NEWS-66** unless the user names another key (NEWS-54/55/58/65/68 Done). Do not open Epics **B–G** until desk v1 is Done (or the user explicitly reorders).
