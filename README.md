...
Agent-facing order of work: **[docs/ROADMAP.md](docs/ROADMAP.md)** (current next: [NEWS-57](https://informedcrew.atlassian.net/browse/NEWS-57) Developing desk — radar → accept → track/mute; start [NEWS-65](https://informedcrew.atlassian.net/browse/NEWS-65)).
