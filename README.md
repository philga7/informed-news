...
Agent-facing order of work: **[docs/ROADMAP.md](docs/ROADMAP.md)** (current next: [NEWS-57](https://informedcrew.atlassian.net/browse/NEWS-57) Developing desk / start [NEWS-54](https://informedcrew.atlassian.net/browse/NEWS-54)).
