...
**Item ordering:** [docs/ROADMAP.md](docs/ROADMAP.md) — current next is Epic **NEWS-57** Developing desk (radar → accept → track/mute; start **NEWS-65**). Do not pick parked B–G epics unless the user reorders.
