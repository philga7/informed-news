...
**Item ordering:** [docs/ROADMAP.md](docs/ROADMAP.md) — current next is Epic **NEWS-57** Developing desk (start **NEWS-54**). Do not pick parked B–G epics unless the user reorders.
